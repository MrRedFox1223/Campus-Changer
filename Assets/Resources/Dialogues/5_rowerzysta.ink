...
Do najróżniejszych wystąpień. Można urządzić tu na przykład mały koncert, wystąpienie publiczne, stand’up albo hmm… konkurs. Tak naprawdę jest mnóstwo możliwości do wykorzystania takiej sceny.
->MainDiscussionNode

== Question_02

To prawda, że takie wydarzenia bywają głośne, ale otaczają nas budynki użytkowe. Wiadomo, że i tak wszystko będzie się działo poza godzinami pracy, bo inaczej studenci i pracownicy nie będą mogli tu przyjść.
->MainDiscussionNode
