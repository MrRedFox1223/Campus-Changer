...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.500000,0.000000,0.000000,1.000000);//UVTiling Normal Intensity (Unknown) Brightness
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,1.000000,0.000000);//Metalic (Unknown) Roughness_Strength (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Local0,View.MaterialTextureMipBias));
	...
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, Local0, 3);
