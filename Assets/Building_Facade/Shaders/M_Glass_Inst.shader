...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.629945,0.663540,0.786458,0.000000);//Base Color
	Material.VectorExpressions[3] = float4(0.629945,0.663540,0.786458,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,23.695322,-14517080.000000,0.000000);//(Unknown) Metallic Roughness (Unknown)
