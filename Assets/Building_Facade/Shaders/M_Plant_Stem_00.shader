Shader "Unreal/MI_Plant_Stem_00"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,1.000000);//UVTiling Normal Intensity (Unknown) Brightnes
	Material.ScalarExpressions[1] = float4(1.000000,0.850000,0.500000,0.000000);//Metalic Roughness_Strength AO_Strength (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, Local0, 4);
	...
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 4);
	...
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, Local0, 2);
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	...
	MaterialFloat Local16 = (Local12.r * Material.ScalarExpressions[1].z);
