...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.668227,2.500000,0.000000,1.000000);//UVTiling Normal Intensity (Unknown) Brightnes
	Material.ScalarExpressions[1] = float4(1.000000,1.500000,0.500000,0.000000);//Metalic Roughness_Strength AO_Strength (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
